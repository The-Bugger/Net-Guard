...
- [ ] 1. Delete demo service, routes, and shell scripts
...
- [ ] 3. Checkpoint — app starts, dashboard loads, zero state on fresh DB
...
- [ ] 4. Add `GET /api/v1/interfaces` endpoint
...
- [ ] 5. Wire interface auto-select in MonitorService
...
- [ ] 6. Emit `monitoring_error` SocketIO event on capture failure
...
- [ ] 7. Replace `get_health_score()` in StatsService
  ...
  - [ ] 7.1 Property test for new health score formula
...
- [ ] 8. Implement `backend/services/security_advisor.py`
  ...
  - [ ] 8.1 Property test for SecurityAdvisor
...
- [ ] 9. Add `GET /api/v1/advisor` route
...
- [ ] 10. Add Security Advisor panel to dashboard
...
- [ ] 11. Add Connected Devices panel to dashboard
...
- [ ] 12. Add `GET /api/v1/devices` route
...
- [ ] 13. Add interface name and monitoring status to dashboard
...
- [ ] 14. Checkpoint — dashboard loads with real data, advisor panel visible,
...
- [ ] 15. Create `scripts/attack_tests/` directory and five attack scripts
...
- [ ] 16. Create `scripts/attack_tests/README.md`
...
- [ ] 17. Audit existing detection rules against requirements
...
- [ ] 18. Final checkpoint — end-to-end smoke test
